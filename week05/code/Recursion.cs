...
public static class Recursion
{
    ...
    public static void PermutationsChoose(List<string> results, string letters, int size, string word = "")
    {
        ...
        // Base case: if the word is of the desired length, add it to results
        if (word.Length == size)
        {
            results.Add(word);
            return;
        ...
        // Recursive case: try each letter not yet in 'word'
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        // Base case: if there are no more wildcards, add to results
        if (!pattern.Contains('*'))
        {
            results.Add(pattern);
            return;
